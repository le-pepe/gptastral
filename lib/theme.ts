export const themeGPT = {
    elements: {
        ...
        userButtonTrigger:
            "!h-10 !p-0 !w-full flex !justify-start hover:!bg-sidebar-accent group-data-[collapsible=icon]:hover:!bg-transparent !px-2 group-data-[collapsible=icon]:!px-0 group-data-[collapsible=icon]:!bg-transparent group-data-[collapsible=icon]:!border-none transition-colors",
        userButtonBox:
            "!text-foreground !gap-2 items-center",
        userButtonOuterIdentifier:
            "text-sm font-medium truncate group-data-[collapsible=icon]:!hidden",
        userButtonPopoverMain: "!bg-secondary/30 !text-card-foreground",
        userButtonPopoverCard: "!bg-secondary/30 !text-card-foreground",
